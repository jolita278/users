            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('fbUrl') ? ' has-error' : '' }}">
                            <label for="password" class="col-md-4 control-label">Facebook URL</label>

                            <div class="col-md-6">
                                <input id="fbUrl" type="text" class="form-control" name="fbUrl" >

                                @if ($errors->has('fbUrl'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('fbUrl') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
                            <label for="password" class="col-md-4 control-label">Age</label>
